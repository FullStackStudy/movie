package com.movie.entity.movie;
...
public class Movie {
    ...
    // 장르
    @Column(name = "movie_genre",nullable = false, length = 500)
    private String genre;

    @Column(name = "movie_cast",nullable = false, columnDefinition = "TEXT")
    private String movieCast;

    @Column(name = "movie_director",nullable = false, length = 200)
    private String movieDirector;

    @Column(name = "movie_rating", nullable = false, length = 20)
    ...
    // 기본 정보 (연령, 상영시간, 개봉국가)
    @Column(name = "movie_detailinfo", columnDefinition = "TEXT")
